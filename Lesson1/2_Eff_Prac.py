...
# Since we're given that manatees has n elements, our code will
# take approximately O(n) time to run.
...
# We aren't iterating over anything - just doing constant-time
# lookups on lists and dictionaries.
...
# NOTES:
# Example 3
# There are two for loops, and nested for loops are a good
# sign that you need to multiply two runtimes.
...
# NOTES:
# Example 4
# Again we have nested for loops. This time we're iterating
# over the manatees list twice - every time we see a manatee, 
